...
geom_cols = ["object_id", "geoid", "town", "county", "geometry"]
info_cols = [
    "object_id",
    "geoid",
    "town",
...
tax_cols = [
    ...
    "town",
    "listed_real_value",
    "homestead_listed_value",
    "non_residential_value",
    "land_value",
    "improvements_value",
    "equipment_value",
    "equipment_code",
    ...
    "statute",
    "exempt",
    "exemption_homestead_amount",
    "exemption_nonresidential_amount",
    "current_use_homestead_reduction_amount",
    "current_use_nonresidential_reduction_amount",
    "gl_value_homestead",
    "gl_value_nonresidential",
    "value_per_acre",
]
