...
export const DATA_SOURCES: Category[] = [
  {
    ...
    datasets: [
      {
        ...
        summary:
          'Small-area estimates of health outcomes, risk behaviors, social needs, and more for Vermont counties and census tracts.',
        ...
        variables: [
          {
            ...
            description: 'Probability of having non-skin cancer or melanoma.',
            key: true,
          },
          {
          ...
          },
          {
            ...
            description:
              'Probability among adults who report always/usually/sometimes feeling lonely.',
            key: true,
          },
          {
            name: 'Receipt of Food Stamps',
            description:
              'Probability among adults who reported receiving food stamps, also called SNAP, the Supplemental Nutrition Assistance Program, on an EBT card.',
            key: true,
          },
          {
            name: 'Food Insecurity',
            description:
              'Probability among adults who reported that the food that they bought always/usually/sometimes did not last, and they didn’t have money to get more.',
            key: true,
          },
          {
            name: 'Housing Insecurity',
            description:
              'Probability among adults who were not able to pay mortgage, rent, or utility bill in the past 12 months.',
            key: true,
          },
          {
            name: 'Lack of Reliable Transportation',
            description:
              'Probability among adults who reported a lack of reliable transportation keeping them from medical appointments, meetings, work, or from getting things needed for daily living in the past 12 months.',
            key: true,
          },
          {
            name: 'Housing Cost Burden',
            description:
              'Households with annual income less than $75,000 that spend 30% or more of their household income on housing.',
            key: true,
          },
          {
            name: 'Crowding Among Housing Units',
            description:
              'Occupied housing units with 1.01 to 1.50 and 1.51 or more occupants per room.',
            key: true,
          },
        ],
      },
      {
        ...
        summary:
          'Those with public, private, or no health insurance from Census ACS 5-year estimates.',
    ...
    datasets: [
      {
        ...
        source: 'UVM VERSO Zoning Atlas Pod',
        updated: '2026',
        icon: MapTrifoldIcon,
...

  {
    ...
    datasets: [
        ...
        variables: [
          {
            ...
            description: 'Median annual household income reported by ACS.',
            key: true,
          },
          {
          ...
          },
          {
            ...
            description: 'Employment counts by NAICS industry sector.',
            key: true,
          },
          {
            name: 'Per Capita Income',
            description: 'Average annual income per person.',
            key: true,
          },
        ],
      },
      ...
      },
      {
        ...
        summary:
          'Median annual earnings (USD) from Census ACS 5-year estimates.',
        source: 'U.S. Census Bureau ACS 5-year Estimates (Table DP03)',
        updated: '2024',
        icon: BriefcaseIcon,
        ...
        variables: [
          ...
          },
          {
            ...
            description:
              'Annual earnings for all workers (Part-time and full-time)',
            key: true,
          },
        ],
      },
    ...
    datasets: [
      {
        ...
        source:
          'U.S. Census Bureau, American Community Survey 5-Year Estimates (Table B15003)',
        updated: '2024',
        icon: HouseIcon,
    ...
    datasets: [
      {
        ...
        source:
          'Vermont Agency of Natural Resources (ANR) NPDES permit database.',
        updated: '2024',
        icon: DropIcon,
      ...
      },
      {
        ...
        variables: [
          ...
          },
          {
            ...
            description:
              'ANR permit ID or name of the receiving treatment facility',
            key: true,
          },
          {
            name: 'RPC',
      ...
      },
      {
        ...
        summary:
          'Stormwater management areas: wet ponds, dry detention basins, bioretention areas, infiltration basins, and similar green/grey infrastructure.',
        ...
        variables: [
          {
            name: 'Type',
            description:
              'Type of stormwater management area (extended detention basin, wet pond, etc.)',
            key: true,
          },
        ],
      },
      ...
      },
      {
        ...
        summary:
          'Shows FEMA-designated flood hazard zones in Vermont, including areas subject to varying levels of flood risk.',
        source:
          'Vermont Center for Geographic Information (VCGI), derived from FEMA National Flood Hazard Layer (NFHL).',
        updated: '2024',
        icon: DropIcon,
    ...
    datasets: [
      {
        ...
        summary:
          'Population, age, sex, and race statistics from Census ACS 5-year estimates.',
      ...
      },
      {
        ...
        source:
          'Vermont Historical Society; Vermont Center for Geographic Information (VCGI)',
        updated: '2024',
        icon: UsersThreeIcon,
      ...
      },
      {
        ...
        summary:
          'Annual age dependency ratio estimates, measuring dependent burden.',
        source: 'U.S. Census Bureau ACS 5-year Estimates (Table DP05)',
        updated: '2024',
        icon: UsersThreeIcon,
