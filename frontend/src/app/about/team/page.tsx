...
const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    role: 'Data Science Coordinator, VERSO & Leahy Center for Rural Studies',
    bio: "Fitz is a recent graduate of the Master's program in Complex Systems and Data Science. He leverages data visualization and accessible analysis for VERSO and the Leahy Center for Rural Studies to improve living conditions across Vermont. He also has a background in technical writing and agricultural work, and has lived in Burlington for the past four years. Outside of work, you'll find him biking, skiing, hiking, or playing guitar in forests and bars across the state.",
