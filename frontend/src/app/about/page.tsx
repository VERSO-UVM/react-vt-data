    ...
    <>
      ...
      >
        ...
        >
          <Stack align="center" gap="xl" maw={1000}>
            ...
            >
              Turning public data into accessible tools that help communities
              understand housing, demographics, infrastructure, environmental
              conditions, and economic trends.
            </Text>

            <Group mt="md">
              <Button component={Link} href="/mapping" size="xl" radius="xl">
                Explore Maps
              </Button>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 6 }}>
            ...
            <Text size="lg" c="dimmed">
              Communities need reliable information to make decisions, but
              important data often exists across disconnected agencies, reports,
              and databases.
            </Text>

            <Text mt="md" size="lg" c="dimmed">
              The Vermont Data Collaborative integrates demographic, housing,
              infrastructure, environmental, and policy data into a single
              platform designed to support planning, research, and public
              decision-making.
            </Text>
          </Grid.Col>
          ...
          <Grid.Col span={{ base: 12, md: 6 }}>
            <Paper withBorder p="xl" radius="md">
              ...
              <Text>
                Empower Vermont communities with accessible, transparent, and
                actionable data that supports evidence-based decision making.
              </Text>
            </Paper>
          </Grid.Col>
        </Grid>
      ...
      <Container size="md" py={100}>
        <Stack align="center" gap="lg">
          <Title ta="center">Ready to Explore Vermont Data?</Title>

          <Text c="dimmed" ta="center">
            Access maps, data tools, and community insights built for Vermont.
          </Text>

          <Group>
            <Button component={Link} href="/mapping" size="lg">
              Launch Maps
            </Button>
