...
interface ChronicDiseaseChartProps {
  primary: DataRow[];
  comparison: DataRow[];
  primaryName: string;
...
// Short axis labels for a subset of the "Health Outcomes" category measures.
const MEASURES: { label: string; measure: string }[] = [
  { label: 'Obesity', measure: 'Obesity among adults' },
  { label: 'Diabetes', measure: 'Diagnosed diabetes among adults' },
  { label: 'High Blood Pressure', measure: 'High blood pressure among adults' },
  { label: 'Depression', measure: 'Depression among adults' },
];
...
export default function ChronicDiseaseChart({
  primary,
  comparison,
  primaryName,
  comparisonName,
}: ChronicDiseaseChartProps) {
